...
# Converts character strings to proper data classes, date and time
...
# Histogram of the subset, color red, H/W of 480, saved to WD folder as "plot1.png" in .png format
